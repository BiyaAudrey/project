...
class Books{
    ...
    public function listBook(){
        ...
        $sqlQuery = "SELECT book.bookID, book.picture, book.name, book.status, book.ISBN
        book.no_of_copy, book.updated_on, author.Name as author_Name, category.Name 
        as categoyry_Name, rack.Name as rack_Name, publisher.Name as publisher_Name
        FROM ".$this->bookTable." book
        LEFT JOIN" .$this->authorTable. " author ON author.authorID = book.authorID
        LEFT JOIN" .$this->categoryTable. " category ON categoryr.categoryID = book.categoryID
      ...
      if(!empty($_POST["search"]["value"])) {
          $sqlQuery = 'WHERE (book.booID LIKE "%' .$_POST["search"]["value"].'%" ';
