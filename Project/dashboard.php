          ...
          <div class="col-xl-3 col-lg-6">
            <div class="card card-inverse card-info">
              <div class="card-block bg-info">
                ...
                <h1 class="display-1"><a href="books.php"><?php 
                echo ($book->getTotalBooks() - $book->getTotalIssuedBooks()); ?></a></h1>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-lg-6">
            <div class="card card-inverse card-warning">
              <div class="card-block bg-warning">
                ...
                <h1 class="display-1"><a href="books.php"><?php 
                echo $book->getTotalReturnedBooks(); ?></a></h1>
              </div>
            </div>
          </div>
		  <div class="col-xl-3 col-lg-6">
            <div class="card card-inverse card-danger">
              <div class="card-block bg-danger">
                ...
                <h1 class="display-1"><a href="issue_books.php"><?php 
                echo $book->getTotalIssuedBooks(); ?></a></h1>
              </div>
            </div>
          </div>
        </div>
